// @observablehq/runtime v4.18.3 Copyright 2021 Observable, Inc.
function e(e, t, n) {
    n = n || {};
...
const Ee = new Date("2019-01-01T00:00").getHours() || new Date("2019-07-01T00:00").getHours(), Ce = new Map, je = [],
    Ne = je.map, $e = je.some, Pe = je.hasOwnProperty, qe = "https://cdn.jsdelivr.net/npm/",
    Se = /^((?:@[^/@]+\/)?[^/@]+)(?:@([^/]+))?(?:\/(.*))?$/, Ae = /^\d+\.\d+\.\d+(-[\w-.+]+)?$/, Oe = /\.[^/]*$/,
...
Ie.amd = {};
const Be = ze("d3", "7.2.1", "dist/d3.min.js"), He = ze("@observablehq/inputs", "0.10.4", "dist/inputs.min.js"),
    We = ze("@observablehq/plot", "0.3.2", "dist/plot.umd.min.js"),
    ...
    rt = ze("apache-arrow", "4.0.1", "Arrow.es2015.min.js"), ot = ze("arquero", "4.8.7", "dist/arquero.min.js"),
...
function mn(e, t) {
    let n, r, o = "function" == typeof IntersectionObserver && t._observer && t._observer._node, i = !o, a = Yt, s = Yt;
