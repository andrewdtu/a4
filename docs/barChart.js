...
export default function define(runtime, observer) {
    ...
    main.variable(observer("md")).define(["md"], function (md) {
        return (
    ...
    main.variable(observer("fileDict")).define("fileDict", function () {
        return (
            {
    ...
    main.variable(observer("viewof radios")).define("viewof radios", ["Inputs"], function (Inputs) {
        return (
    ...
    main.variable(observer("viewof selection")).define("viewof selection", ["FileAttachment", "fileDict", "select", "html"], function (FileAttachment, fileDict, select, html) {
            ...
            return Object.defineProperty(html`
                <div>${form}`, 'value', {
                get() {
    ...
    main.variable(observer("focus")).define("focus", ["Generators", "linechart"], function (Generators, linechart) {
        return (
            Generators.input(linechart)
        )
    });
    main.variable(observer("LineChart")).define("LineChart", ["d3", "margin"], function (d3, margin) {
        return (
    ...
    main.variable(observer("rating_data")).define("rating_data", ["FileAttachment"], function (FileAttachment) {
        return (
    ...
    main.variable(observer()).define(["selection"], function (selection) {
        return (
            selection.csv({typed: true})
        )
    });
    main.variable(observer("data")).define("data", ["selection"], function (selection) {
        return (
            selection.csv({typed: true})
        )
    });
